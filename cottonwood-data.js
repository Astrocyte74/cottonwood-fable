...
//
// Section keys: "R<range>S<section>"  e.g. "R3S16" = Sec 16, Rge 3, Twp 35 W5.
...
const COTTONWOOD_SEED = {
  ...
  // --------------------------------------------------------------------------
  landmarks: [
    { name: "Mountain House (A. Caldwell)", icon: "house", rge: 3, sec: 16, fx: 0.55, fy: 0.65,
      note: "Stopping house, c. 1903–1905. Marked with a dot on the 1901–1911 sheet." },
    { name: "Cottonwood School — site 1 (1904–1923)", icon: "school", rge: 2, sec: 16, fx: 0.10, fy: 0.15,
      note: "Star on the plat maps near the SW corner of Sec 16, Rge 2." },
    { name: "Cottonwood School — site 2 (1923–1957)", icon: "school", rge: 2, sec: 7, fx: 0.05, fy: 0.55,
      note: "Later school site, west edge of Sec 7, Rge 2." },
    { name: "Cottonwood School No. 2 (1940–1947)", icon: "school", rge: 3, sec: 9, fx: 0.85, fy: 0.95,
      note: "Star on the 1917–1927 sheet near the Sec 9/10 line, Rge 3." },
    { name: "Moose Mountain Bridge (1903–1943?)", icon: "bridge", rge: 3, sec: 9, fx: 0.05, fy: 0.90,
      note: "Red Deer River crossing; dates partly illegible (1903–1925 or 1903–1943)." },
    { name: "Ferry", icon: "ferry", rge: 3, sec: 21, fx: 0.15, fy: 0.85,
      note: "Ferry crossing on the Red Deer River, NW part of Sec 21, Rge 3." },
    { name: "Mountain House (Moose Ridge)", icon: "house", rge: 3, sec: 1, fx: 0.70, fy: 0.10,
