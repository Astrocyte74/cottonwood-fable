...
(function () {
  ...
  var css = ""
    ...
    + ".sh-controls{display:flex;align-items:center;gap:14px;flex-wrap:wrap;margin-top:7px;padding:7px 0 0;"
    ...
    + ".sh-controls .pt-spacer{flex:1;min-width:32px;}"
    ...
    + ".sh-controls{gap:10px;}.control-group{gap:6px;}.mapmode .mm,.sh-period .sh-pchip,.sh-print,.site-header .btn{font-size:14px;padding:7px 10px;}}"
